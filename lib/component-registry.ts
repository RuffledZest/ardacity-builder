...
export const componentRegistry: ComponentDefinition[] = [
  ...
  },
  {
    ...
    type: "StakingPanel",
    description:
      "Retro-style staking interface with real-time message logging. Stake, unstake, and finalize operations with AO process integration and ArConnect wallet support.",
    defaultProps: {},
    dependencies: ["@permaweb/aoconnect"],
